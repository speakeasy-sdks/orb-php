...
use \orb\orb\Models\Operations\AmendEventRequestBodyProperties;
...
try {
    ...
    $request->requestBody->customerId = 'aliquid';
    $request->requestBody->eventName = 'laborum';
    $request->requestBody->externalCustomerId = 'accusamus';
    $request->requestBody->properties = new AmendEventRequestBodyProperties();
...
try {
    ...
    $request->closeTime = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-05-17T08:24:52.669Z');
    $request->customerId = 'accusamus';
    $request->externalCustomerId = 'delectus';
    $request->replaceExistingEvents = false;
    $request->timeframeEnd = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-10-28T10:05:29.849Z');
    $request->timeframeStart = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-09-06T10:36:33.442Z');
...
use \orb\orb\Models\Operations\IngestRequestBodyEventsProperties;
