...
use \orb\orb\Models\Operations\CancelSubscriptionRequest;
use \orb\orb\Models\Operations\CancelSubscriptionRequestBody;
use \orb\orb\Models\Operations\CancelSubscriptionRequestBodyCancelOption;
...
try {
    ...
    $request->requestBody->cancelOption = CancelSubscriptionRequestBodyCancelOption::Immediate;
    $request->requestBody->cancellationDate = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2017-07-21T17:32:28Z');
    $request->subscriptionId = 'voluptas';
...
use \orb\orb\SDK;
use \orb\orb\Models\Shared\Security;
use \orb\orb\Models\Operations\CreateSubscriptionApplicationJSON;
use \orb\orb\Models\Operations\CreateSubscriptionApplicationJSONExternalMarketplace;
use \orb\orb\Models\Operations\CreateSubscriptionApplicationJSONMetadata;
use \orb\orb\Models\Operations\CreateSubscriptionApplicationJSONPhaseOverrides;
...
try {
    $request = new CreateSubscriptionApplicationJSON();
    $request->alignBillingWithSubscriptionStartDate = false;
    $request->autoCollection = false;
    $request->couponRedemptionCode = 'natus';
    $request->customerId = '97DPcZE9hxsbb9Y9';
    $request->defaultInvoiceMemo = 'eos';
    $request->externalCustomerId = 'atque';
    $request->externalMarketplace = CreateSubscriptionApplicationJSONExternalMarketplace::Google;
    $request->externalMarketplaceReportingId = 'project_number:983410661111';
    $request->externalPlanId = 'sit';
    $request->metadata = new CreateSubscriptionApplicationJSONMetadata();
    $request->minimumAmount = '1.23';
    $request->netTerms = 0;
    $request->phaseOverrides = [
        new CreateSubscriptionApplicationJSONPhaseOverrides(),
        new CreateSubscriptionApplicationJSONPhaseOverrides(),
        new CreateSubscriptionApplicationJSONPhaseOverrides(),
        new CreateSubscriptionApplicationJSONPhaseOverrides(),
    ];
    $request->planId = 'ZMwNQefe7J3ecf7W';
    $request->priceOverrides = [
        new CreateSubscriptionApplicationJSONPriceOverrides6(),
    ];
    $request->startDate = DateTime::createFromFormat('Y-m-d', '2022-01-01');

    $response = $sdk->subscription->create($request);
...
use \orb\orb\SDK;
use \orb\orb\Models\Shared\Security;
use \orb\orb\Models\Operations\FetchSubscriptionRequest;
...
try {
    ...
    $request->subscriptionId = 'iusto';

    $response = $sdk->subscription->fetch($request);
...
use \orb\orb\SDK;
use \orb\orb\Models\Shared\Security;
use \orb\orb\Models\Operations\FetchSubscriptionCostsRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new FetchSubscriptionCostsRequest();
    $request->groupBy = 'voluptate';
    $request->subscriptionId = 'dolorum';
    $request->timeframeEnd = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-02-02T05:00:00Z');
    $request->timeframeStart = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-02-02T05:00:00Z');
    $request->viewMode = 'deleniti';

    $response = $sdk->subscription->fetchCosts($request);

    if ($response->fetchSubscriptionCosts200ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \orb\orb\SDK;
use \orb\orb\Models\Shared\Security;
use \orb\orb\Models\Operations\FetchSubscriptionScheduleRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new FetchSubscriptionScheduleRequest();
    $request->subscriptionId = 'omnis';

    $response = $sdk->subscription->fetchSchedule($request);

    if ($response->fetchSubscriptionSchedule200ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \orb\orb\SDK;
use \orb\orb\Models\Shared\Security;
use \orb\orb\Models\Operations\FetchSubscriptionUsageRequest;
use \orb\orb\Models\Operations\FetchSubscriptionUsageGranularity;
use \orb\orb\Models\Operations\FetchSubscriptionUsageViewMode;

$sdk = SDK::builder()
    ->build();

try {
    $request = new FetchSubscriptionUsageRequest();
    $request->billableMetricId = 'necessitatibus';
    $request->granularity = FetchSubscriptionUsageGranularity::Day;
    $request->groupBy = 'distinctio';
    $request->subscriptionId = 'asperiores';
    $request->timeframeEnd = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-02-02T05:00:00Z');
    $request->timeframeStart = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-02-02T05:00:00Z');
    $request->viewMode = FetchSubscriptionUsageViewMode::Periodic;

    $response = $sdk->subscription->fetchUsage($request);

    if ($response->fetchSubscriptionUsage200ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \orb\orb\SDK;
use \orb\orb\Models\Shared\Security;
use \orb\orb\Models\Operations\ListSubscriptionsRequest;
...
try {
    ...
    $request->customerId = 'ipsum';
    $request->externalCustomerId = 'voluptate';

    $response = $sdk->subscription->list($request);
...
use \orb\orb\SDK;
use \orb\orb\Models\Shared\Security;
use \orb\orb\Models\Operations\SchedulePlanChangeRequest;
use \orb\orb\Models\Operations\SchedulePlanChangeRequestBody;
use \orb\orb\Models\Operations\SchedulePlanChangeRequestBodyChangeOption;

$sdk = SDK::builder()
    ->build();

try {
    $request = new SchedulePlanChangeRequest();
    $request->requestBody = new SchedulePlanChangeRequestBody();
    $request->requestBody->alignBillingWithPlanChangeDate = false;
    $request->requestBody->changeDate = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2017-07-21T17:32:28Z');
    $request->requestBody->changeOption = SchedulePlanChangeRequestBodyChangeOption::EndOfSubscriptionTerm;
    $request->requestBody->couponRedemptionCode = 'saepe';
    ...
    $request->requestBody->priceOverrides = [
        new SchedulePlanChangeRequestBodyPriceOverrides1(),
        new SchedulePlanChangeRequestBodyPriceOverrides1(),
    ];
    $request->subscriptionId = 'amet';

    $response = $sdk->subscription->schedulePlanChange($request);
...
use \orb\orb\SDK;
use \orb\orb\Models\Shared\Security;
use \orb\orb\Models\Operations\UnscheduleCancellationRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new UnscheduleCancellationRequest();
    $request->subscriptionId = 'optio';

    $response = $sdk->subscription->unscheduleCancellation($request);
...
use \orb\orb\SDK;
use \orb\orb\Models\Shared\Security;
use \orb\orb\Models\Operations\UnschedulePlanChangeRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new UnschedulePlanChangeRequest();
    $request->subscriptionId = 'accusamus';

    $response = $sdk->subscription->unschedulePlanChange($request);
...
use \orb\orb\SDK;
use \orb\orb\Models\Shared\Security;
use \orb\orb\Models\Operations\UpdateFixedFeeQuantityRequest;
use \orb\orb\Models\Operations\UpdateFixedFeeQuantityRequestBody;
use \orb\orb\Models\Operations\UpdateFixedFeeQuantityRequestBodyChangeOption;

$sdk = SDK::builder()
    ->build();

try {
    $request = new UpdateFixedFeeQuantityRequest();
    $request->requestBody = new UpdateFixedFeeQuantityRequestBody();
    $request->requestBody->changeOption = UpdateFixedFeeQuantityRequestBodyChangeOption::EffectiveDate;
    $request->requestBody->effectiveDate = DateTime::createFromFormat('Y-m-d', '"2022-12-21"');
    $request->requestBody->priceId = 'ad';
    $request->requestBody->quantity = 9044.25;
    $request->subscriptionId = 'suscipit';

    $response = $sdk->subscription->updateFixedFeeQuantity($request);
