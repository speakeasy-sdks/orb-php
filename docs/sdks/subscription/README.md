...
try {
    ...
    $request->couponRedemptionCode = 'eos';
    $request->customerId = '97DPcZE9hxsbb9Y9';
    $request->defaultInvoiceMemo = 'atque';
    $request->externalCustomerId = 'sit';
    ...
    $request->priceOverrides = [
        new CreateSubscriptionApplicationJSONPriceOverrides5(),
        new CreateSubscriptionApplicationJSONPriceOverrides4(),
        new CreateSubscriptionApplicationJSONPriceOverrides4(),
    ];
...
try {
    ...
    $request->viewMode = 'necessitatibus';
...
try {
    ...
    $request->subscriptionId = 'distinctio';
...
try {
    ...
    $request->billableMetricId = 'asperiores';
    $request->granularity = FetchSubscriptionUsageGranularity::Day;
    $request->groupBy = 'nihil';
    $request->subscriptionId = 'ipsum';
    $request->timeframeEnd = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-02-02T05:00:00Z');
    $request->timeframeStart = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-02-02T05:00:00Z');
...
try {
    ...
    $request->requestBody->changeOption = SchedulePlanChangeRequestBodyChangeOption::RequestedDate;
    $request->requestBody->couponRedemptionCode = 'aspernatur';
    ...
    $request->requestBody->priceOverrides = [
        new SchedulePlanChangeRequestBodyPriceOverrides2(),
    ];
...
try {
    ...
    $request->requestBody->priceId = 'saepe';
    $request->requestBody->quantity = 3834.64;
    $request->subscriptionId = 'deserunt';
