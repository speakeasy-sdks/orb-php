...
try {
    $request = new PostSubscriptionsSubscriptionIdSchedulePlanChangeRequest();
    ...
    $request->requestBody->priceOverrides = [
        new PostSubscriptionsSubscriptionIdSchedulePlanChangeRequestBodyPriceOverrides1(),
        new PostSubscriptionsSubscriptionIdSchedulePlanChangeRequestBodyPriceOverrides7(),
        new PostSubscriptionsSubscriptionIdSchedulePlanChangeRequestBodyPriceOverrides3(),
    ];
    $request->subscriptionId = 'voluptatibus';

    $response = $sdk->subscription->changeSchedule($request);
...
try {
    $request = new PostSubscriptionsRequestBody();
    ...
    $request->phaseOverrides = [
        new PostSubscriptionsRequestBodyPhaseOverrides(),
    ];
    $request->planId = 'ZMwNQefe7J3ecf7W';
    $request->priceOverrides = [
        new PostSubscriptionsRequestBodyPriceOverrides6(),
    ];
...
use \orb\orb\SDK;
use \orb\orb\Models\Shared\Security;
use \orb\orb\Models\Operations\GetSubscriptionsSubscriptionIdRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetSubscriptionsSubscriptionIdRequest();
    $request->subscriptionId = 'corporis';

    $response = $sdk->subscription->get($request);
...
use \orb\orb\SDK;
use \orb\orb\Models\Shared\Security;
use \orb\orb\Models\Operations\GetSubscriptionsSubscriptionIdCostRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetSubscriptionsSubscriptionIdCostRequest();
    $request->groupBy = 'hic';
    $request->subscriptionId = 'libero';
    ...
    $request->viewMode = 'nobis';

    $response = $sdk->subscription->getCost($request);

    if ($response->getSubscriptionsSubscriptionIdCost200ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \orb\orb\SDK;
use \orb\orb\Models\Shared\Security;
use \orb\orb\Models\Operations\GetSubscriptionsSubscriptionIdScheduleRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetSubscriptionsSubscriptionIdScheduleRequest();
    $request->subscriptionId = 'dolores';

    $response = $sdk->subscription->getSchedule($request);

    if ($response->getSubscriptionsSubscriptionIdSchedule200ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $response = $sdk->subscription->getUsage($request);
...
try {
    ...
    $request->externalCustomerId = 'quis';
...
use \orb\orb\SDK;
use \orb\orb\Models\Shared\Security;
use \orb\orb\Models\Operations\PostSubscriptionsSubscriptionIdUnschedulePendingPlanChangesRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new PostSubscriptionsSubscriptionIdUnschedulePendingPlanChangesRequest();
    $request->subscriptionId = 'nesciunt';

    $response = $sdk->subscription->unschedule($request);
