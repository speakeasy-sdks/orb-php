...
try {
    ...
    $request->couponRedemptionCode = 'id';
    $request->customerId = '97DPcZE9hxsbb9Y9';
    $request->defaultInvoiceMemo = 'saepe';
    $request->externalCustomerId = 'eius';
    ...
    $request->externalPlanId = 'aspernatur';
    $request->metadata = [
        'amet' => 'optio',
    ];
    ...
    $request->priceOverrides = [
        new CreateSubscriptionApplicationJSONPriceOverrides7(),
        new CreateSubscriptionApplicationJSONPriceOverrides3(),
    ];
...
try {
    ...
    $request->groupBy = 'provident';
    $request->subscriptionId = 'minima';
...
try {
    ...
    $request->billableMetricId = 'similique';
    $request->granularity = FetchSubscriptionUsageGranularity::DAY;
    $request->groupBy = 'alias';
    $request->subscriptionId = 'at';
    $request->timeframeEnd = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-02-02T05:00:00Z');
    $request->timeframeStart = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-02-02T05:00:00Z');
...
try {
    ...
    $request->customerId = 'tempora';
    $request->externalCustomerId = 'vel';
...
try {
    ...
    $request->requestBody->changeOption = SchedulePlanChangeRequestBodyChangeOption::IMMEDIATE;
    $request->requestBody->couponRedemptionCode = 'officiis';
    ...
    $request->requestBody->priceOverrides = [
        new SchedulePlanChangeRequestBodyPriceOverrides5(),
    ];
    $request->subscriptionId = 'a';
...
try {
    ...
    $request->requestBody->changeOption = UpdateFixedFeeQuantityRequestBodyChangeOption::EFFECTIVE_DATE;
    $request->requestBody->effectiveDate = DateTime::createFromFormat('Y-m-d', '"2022-12-21"');
    $request->requestBody->priceId = 'iusto';
    $request->requestBody->quantity = 2155.07;
    $request->subscriptionId = 'quisquam';
