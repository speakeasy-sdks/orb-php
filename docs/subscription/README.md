...
try {
    ...
    $request->subscriptionId = 'repellendus';
...
try {
    ...
    $request->subscriptionId = 'similique';
...
try {
    ...
    $request->billableMetricId = 'quaerat';
    $request->granularity = FetchSubscriptionUsageGranularity::DAY;
    $request->groupBy = 'tempora';
    $request->subscriptionId = 'vel';
    $request->timeframeEnd = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-02-02T05:00:00Z');
    $request->timeframeStart = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-02-02T05:00:00Z');
    $request->viewMode = FetchSubscriptionUsageViewMode::CUMULATIVE;
...
try {
    ...
    $request->customerId = 'officiis';
    $request->externalCustomerId = 'qui';
...
try {
    ...
    $request->requestBody->couponRedemptionCode = 'a';
    ...
    $request->requestBody->priceOverrides = [
        ...
        new SchedulePlanChangeRequestBodyPriceOverrides4(),
    ];
    $request->subscriptionId = 'ipsum';
...
try {
    ...
    $request->subscriptionId = 'tenetur';
...
try {
    ...
    $request->requestBody->priceId = 'amet';
    $request->requestBody->quantity = 7308.56;
