...
class Credit 
{
     ...
     * 
     * @param \orb\orb\Models\Operations\AddLedgerEntryExternalIdRequest $request
     * @return \orb\orb\Models\Operations\AddLedgerEntryExternalIdResponse
     */
	public function addByExternalId(
        \orb\orb\Models\Operations\AddLedgerEntryExternalIdRequest $request,
    ): \orb\orb\Models\Operations\AddLedgerEntryExternalIdResponse
    {
        $baseUrl = $this->sdkConfiguration->getServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/customers/external_customer_id/{external_customer_id}/credits/ledger_entry', \orb\orb\Models\Operations\AddLedgerEntryExternalIdRequest::class, $request);
        ...
        $response = new \orb\orb\Models\Operations\AddLedgerEntryExternalIdResponse();
     ...
     * ```
     * 
     * @param \orb\orb\Models\Operations\CreateLedgerEntryRequest $request
     * @return \orb\orb\Models\Operations\CreateLedgerEntryResponse
     */
	public function create(
        \orb\orb\Models\Operations\CreateLedgerEntryRequest $request,
    ): \orb\orb\Models\Operations\CreateLedgerEntryResponse
    {
        $baseUrl = $this->sdkConfiguration->getServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/customers/{customer_id}/credits/ledger_entry', \orb\orb\Models\Operations\CreateLedgerEntryRequest::class, $request);
        ...
        $response = new \orb\orb\Models\Operations\CreateLedgerEntryResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \orb\orb\Models\Operations\FetchCustomerCreditsRequest $request
     * @return \orb\orb\Models\Operations\FetchCustomerCreditsResponse
     */
	public function fetch(
        \orb\orb\Models\Operations\FetchCustomerCreditsRequest $request,
    ): \orb\orb\Models\Operations\FetchCustomerCreditsResponse
    {
        $baseUrl = $this->sdkConfiguration->getServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/customers/{customer_id}/credits', \orb\orb\Models\Operations\FetchCustomerCreditsRequest::class, $request);
        ...
        $response = new \orb\orb\Models\Operations\FetchCustomerCreditsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->fetchCustomerCredits200ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'orb\orb\Models\Operations\FetchCustomerCredits200ApplicationJSON', 'json');
            }
        }
     ...
     * 
     * @param \orb\orb\Models\Operations\FetchCustomerCreditsExternalIdRequest $request
     * @return \orb\orb\Models\Operations\FetchCustomerCreditsExternalIdResponse
     */
	public function fetchByExternalId(
        \orb\orb\Models\Operations\FetchCustomerCreditsExternalIdRequest $request,
    ): \orb\orb\Models\Operations\FetchCustomerCreditsExternalIdResponse
    {
        $baseUrl = $this->sdkConfiguration->getServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/customers/external_customer_id.{external_customer_id}/credits', \orb\orb\Models\Operations\FetchCustomerCreditsExternalIdRequest::class, $request);
        ...
        $response = new \orb\orb\Models\Operations\FetchCustomerCreditsExternalIdResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->fetchCustomerCreditsExternalId200ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'orb\orb\Models\Operations\FetchCustomerCreditsExternalId200ApplicationJSON', 'json');
            }
        }
     ...
     * 
     * @param \orb\orb\Models\Operations\FetchCustomerCreditsLedgerRequest $request
     * @return \orb\orb\Models\Operations\FetchCustomerCreditsLedgerResponse
     */
	public function fetchLedger(
        \orb\orb\Models\Operations\FetchCustomerCreditsLedgerRequest $request,
    ): \orb\orb\Models\Operations\FetchCustomerCreditsLedgerResponse
    {
        $baseUrl = $this->sdkConfiguration->getServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/customers/{customer_id}/credits/ledger', \orb\orb\Models\Operations\FetchCustomerCreditsLedgerRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\orb\orb\Models\Operations\FetchCustomerCreditsLedgerRequest::class, $request, null));
        $options['headers']['Accept'] = 'application/json';
        $options['headers']['user-agent'] = sprintf('speakeasy-sdk/%s %s %s', $this->sdkConfiguration->language, $this->sdkConfiguration->sdkVersion, $this->sdkConfiguration->genVersion);
        ...
        $response = new \orb\orb\Models\Operations\FetchCustomerCreditsLedgerResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->fetchCustomerCreditsLedger200ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'orb\orb\Models\Operations\FetchCustomerCreditsLedger200ApplicationJSON', 'json');
            }
        }
     ...
     * 
     * @param \orb\orb\Models\Operations\FetchCustomerCreditsLedgerExternalIdRequest $request
     * @return \orb\orb\Models\Operations\FetchCustomerCreditsLedgerExternalIdResponse
     */
	public function fetchLedgerByExternalId(
        \orb\orb\Models\Operations\FetchCustomerCreditsLedgerExternalIdRequest $request,
    ): \orb\orb\Models\Operations\FetchCustomerCreditsLedgerExternalIdResponse
    {
        $baseUrl = $this->sdkConfiguration->getServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/customers/external_customer_id/{external_customer_id}/credits/ledger', \orb\orb\Models\Operations\FetchCustomerCreditsLedgerExternalIdRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\orb\orb\Models\Operations\FetchCustomerCreditsLedgerExternalIdRequest::class, $request, null));
        $options['headers']['Accept'] = 'application/json';
        $options['headers']['user-agent'] = sprintf('speakeasy-sdk/%s %s %s', $this->sdkConfiguration->language, $this->sdkConfiguration->sdkVersion, $this->sdkConfiguration->genVersion);
        ...
        $response = new \orb\orb\Models\Operations\FetchCustomerCreditsLedgerExternalIdResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->fetchCustomerCreditsLedgerExternalId200ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'orb\orb\Models\Operations\FetchCustomerCreditsLedgerExternalId200ApplicationJSON', 'json');
            }
        }
