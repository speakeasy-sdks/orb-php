 ...
 * @access public
 */
class AmendUsage200ApplicationJSON
{
    /**
     * An array of strings, corresponding to idempotency_key's marked as duplicates (previously ingested)
     * 
     * @var ?array<\orb\orb\Models\Operations\AmendUsage200ApplicationJSONDuplicate> $duplicate
     */
	#[\JMS\Serializer\Annotation\SerializedName('duplicate')]
    #[\JMS\Serializer\Annotation\Type('array<orb\orb\Models\Operations\AmendUsage200ApplicationJSONDuplicate>')]
