...
class Plan 
{
     ...
     * 
     * 
     * @param \Orb\Orb\Models\Operations\GetPlansRequestBody $request
     * @return \Orb\Orb\Models\Operations\GetPlansResponse
     */
	public function get(
        \Orb\Orb\Models\Operations\GetPlansRequestBody $request,
    ): \Orb\Orb\Models\Operations\GetPlansResponse
    {
        $baseUrl = $this->_serverUrl;
        ...
        $response = new \Orb\Orb\Models\Operations\GetPlansResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
